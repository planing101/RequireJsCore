...
namespace RequireJsCore.Helpers
{
    internal static class PathHelpers
    {
        ...
        public static string MapPath(this ViewContext viewContext, string path)
        {
            if (path.StartsWith("~")) 
                path = path.TrimStart('~');
            ...
            // Path is at webroot
            var env = (IHostingEnvironment)viewContext.HttpContext.RequestServices.GetService(typeof(IHostingEnvironment));
        ...
        public static string ToModuleName(this string relativePath)
        {
            ...
            var file = relativePath.EndsWith(".js") 
